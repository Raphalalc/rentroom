...
if(isset($_POST['reservation'])){
    ...
    if($_SESSION['id']==null){
        flashReservation('Vous devez être connecté pour réserver une room <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle-fill" viewBox="0 0 16 16">
